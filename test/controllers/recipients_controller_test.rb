...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { age: @recipient.age, first: @recipient.first, last: @recipient.last, notes: @recipient.notes, size: @recipient.size, user_id: @recipient.user_id }
    end
  ...
  test "should update recipient" do
    patch :update, id: @recipient, recipient: { age: @recipient.age, first: @recipient.first, last: @recipient.last, notes: @recipient.notes, size: @recipient.size, user_id: @recipient.user_id }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
